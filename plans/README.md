...
|------|-------|--------|----------|-------------|
| [2026-09-05-post-meeting-notes-and-prompt-context](active/2026-09-05-post-meeting-notes-and-prompt-context.md) | Post-meeting notes, opt-in prompt context, and rich Markdown follow-up | **IMPLEMENTED — MANUAL QA PENDING** | P2 | Saved-note editing, opt-in context, exact snapshots, CLI/artifacts, and shared static/streaming rich Markdown are implemented and locally verified. Before PR/release: complete visual/accessibility QA and measure the release-bundle size delta. |
