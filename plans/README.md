...
| [2026-09-05-versioned-prompt-manager-meeting-classification](active/2026-09-05-versioned-prompt-manager-meeting-classification.md) | Versioned Prompt Manager and meeting classification | **PROPOSED** | P1/P2 | Approved design draft for immutable prompt versions, Markdown editing/diff, uniform built-in CRUD, prompt collections, meeting types/labels, and type-aware prompt availability/auto-run. Next: explicit execution approval, then Slice 0 governing ADR/contract changes. |
